...
public class BSX extends Plugin
     ...
     */
    protected final BSXDisplay visual = new BSXDisplay();
    /**
     * the container for this plugin
     */
    protected final JPanel panel = new JPanel(new FlowLayout(FlowLayout.CENTER));
     ...
     */
    protected static final String VERSION = "Java 1.0";
    /**
     * ignoreErrors in BSX data
     */
    protected final boolean ignoreErrors = true;
  ...
  /*                         Buffers & States                              */
  /* ********************************************************************* */
    private final byte[] cmd = new byte[4];      // command                      */
    private int cmdlen = 0;                // length of command            */
    private final byte[] id = new byte[64];     // identifier                   */
    private int idlen = 0;                // length of identifier         */
    private String obj = null;             // string representation of id  */
    private int[][] data = null;             // data                         */
    private final byte[] hex = new byte[2];      // 00-FF integer                */
    private int hexlen = 0;                // length of integer            */
    private final byte[] res = new byte[4096];   // storage for parse-result     */
    /* ********************************************************************* */
