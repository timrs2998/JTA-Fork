...
public class SshMisc {
     ...
     * the string value.  There are no terminating null characters.
     */
    static public byte[] createString(String str) {
        ...
        System.arraycopy(strByte, 0, value, 4, length);
        return value;
    } //createString
     ...
     */
    static private final long[] crc32_tab = {0x00000000L, 0x77073096L, 0xee0e612cL, 0x990951baL, 0x076dc419L,
