...
public class Applet extends JApplet {
    ...
    public void init() {
        ...
        if (pluginLoader == null) {
            ...
            for (Object o1 : componentList.keySet()) {
            ...
            pluginLoader.registerPluginListener((SoundListener) audioClip -> Applet.this.getAudioClip(audioClip).play());
            ...
            if (appletFrame != this) {
                ...
                tmp.addActionListener(evt -> pluginLoader.broadcast(new SocketRequest(host,
                        Integer.parseInt(port))));
                file.add(tmp = new MenuItem("Disconnect"));
                tmp.addActionListener(evt -> pluginLoader.broadcast(new SocketRequest()));
                ...
                tmp.addActionListener(e -> Help.show(appletFrame.getContentPane(), options.getProperty("Help.url")));
                mb.setHelpMenu(help);
