...
public class MUDColorizer extends Plugin
    ...
    private static final String BRED = "[1;31m";
    private static final String GREEN = "[32m";
    private static final String BGREEN = "[1;32m";
    private static final String YELLOW = "[33m";
    private static final String BYELLOW = "[1;33m";
    private static final String BLUE = "[34m";
    private static final String BBLUE = "[1;34m";
    private static final String PINK = "[35m";
    private static final String BPINK = "[1;35m";
    private static final String CYAN = "[36m";
    private static final String BCYAN = "[1;36m";
    private static final String WHITE = "[37m";
    private static final String BWHITE = "[1;37m";
   ...
   */
    ...
    private MUDColorizer(PluginBus bus, final String id) {
        super(bus, id);
            ...
            if (regexpSet != null && !regexpSet.isEmpty()) {
                ...
                while (names.hasMoreElements()) {
                    ...
                    try {
                        ...
                        logger.log(Level.SEVERE, "Something wrong with regexp: " +
                                ex + "\t" + exp);
            ...
            if (line[lp] == '\n') {
                ...
                for (int ex = 0; !colored && useexp && ex < exps.length; ex += 2) {
                    ...
                    if (null != exp.getMatch(l)) {
                        byte[] color = ((String) exps[ex + 1]).getBytes();
